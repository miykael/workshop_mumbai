...
# Timestamp: 2018-07-06 01:23:31 UTC
# 
...
RUN echo '{ \
    ...
    \n    [ \
    \n      "run", \
    \n      "curl -L -o /data/dataset.zip https://www.dropbox.com/s/7ayjgwrlp3xa8jq/dataset.zip?dl=1 && unzip /data/dataset.zip -d /data/ && rm /data/dataset.zip" \
    \n    ], \
    \n    [ \
    \n      "run", \
    \n      "curl -L -o /output/datasink.zip https://www.dropbox.com/s/6o49kokagze9nnk/datasink.zip?dl=1 && unzip /output/datasink.zip -d /output/ && rm /output/datasink.zip" \
    \n    ], \
    \n    [ \
    \n      "copy", \
    \n      [ \
