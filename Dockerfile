...
# Timestamp: 2018-07-05 15:01:06 UTC
# 
...
RUN echo '{ \
    ...
    \n    [ \
    \n      "run", \
    \n      "curl -L -o /data/dataset.zip https://www.dropbox.com/s/q5xxcb98j0w8g96/dataset.zip?dl=1 && unzip /data/dataset.zip -d /data/ && rm /data/dataset.zip" \
    \n    ], \
    \n    [ \
    \n      "copy", \
    \n      [ \
